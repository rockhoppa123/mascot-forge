...
**Provenance (do not regenerate):** The maintainer supplied `Series III Land Rover Mascot.jpg`
(1024×1024 JPEG with a baked-in checkerboard "transparency" pattern — JPEG has no alpha).
Step-0 source prep (`spikes/03-second-asset/prep-source.ps1`, maintainer-approved) keyed the
